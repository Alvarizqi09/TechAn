        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="{{asset('themes/TechAn/assets/img/slide1.jpg')}}" class="d-block w-100" alt="slide 1">
            </div>
            <div class="carousel-item">
              <img src="{{asset('themes/TechAn/assets/img/slide2.jpg')}}" class="d-block w-100" alt="slide 2">
            </div>
          </div>
