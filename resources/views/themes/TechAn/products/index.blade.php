      ...
      <div class="container">
        <div class="row">
                ...
                <div class="widget-content widget-categories">
                  <ul class="nav nav-category">
                    <li class="nav-item border-bottom w-100">
                      <a class="nav-link active" aria-current="page" href="#">Computer <i class='bx bx-chevron-right'></i></a>
                    </li>
                    <li class="nav-item border-bottom w-100">
                      <a class="nav-link" href="#">Handphone <i class='bx bx-chevron-right'></i></a>
                    </li>
                    <li class="nav-item border-bottom w-100">
                      <a class="nav-link" href="#">Headphone <i class='bx bx-chevron-right'></i></a>
                    </li>
                    <li class="nav-item border-bottom w-100">
                      <a class="nav-link" href="#">Sparepart <i class='bx bx-chevron-right'></i></a>
                    </li>
                    <li class="nav-item border-bottom w-100">
          ...
          <section class="col-lg-9 col-md-12 products">
            <div class="card mb-2 bg-light border-0 section-header">
            ...
            <div class="row">
              @forelse ($products as $product)
                @include('themes.TechAn.products.product_box',['product' => $product])
                @empty
                <p>product empty</p>
              @endforelse
            </div>
